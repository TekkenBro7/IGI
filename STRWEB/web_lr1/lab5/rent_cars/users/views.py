...
def index(request):
   ...
   # return HttpResponse(age)
    ...
    article = NewsArticle.objects.order_by('time_create').first()
    ...
    return render(request, 'users/index.html', {'current_month': current_month, 'current_year': current_year, 'cal': cal, 'month_number': month_number, 'user_timezone': user_timezone, 'current_date': current_date, 'body_types': body_types, 'cars': cars, 'discounts': discounts, 'penalties': penalties, 'promoCodes': promoCodes, 'article': article, 'partners': partners})

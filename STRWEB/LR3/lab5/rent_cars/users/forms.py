...
from .models import User, Customer, SliderSettings
...
class SliderSettingsForm(forms.ModelForm):
    ...
    navs = forms.BooleanField(
        required=False,
        widget=forms.CheckboxInput(),
        label='Navigation Controls'
    )
    pags = forms.BooleanField(
        required=False,
        widget=forms.CheckboxInput(),
    ...
    class Meta:
        ...
        fields = ['delay', 'loop', 'navs', 'pags', 'auto']
...
from cars.models import Car, BodyType, CarModel, Cart
...
def add_to_cart(request, car_id):
    ...
    existing_cart_item = Cart.objects.filter(user=customer, car=car).first()  
    if existing_cart_item:
        return redirect('about_company')
    cart_item = Cart(user=customer, car=car)
    cart_item.save()
